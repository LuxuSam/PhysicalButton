...
$(function() {
    function PhysicalbuttonViewModel(parameters) {
        ...
        self.settingsViewModel = parameters[0];
         ...
         //actions:
         self.actions = ko.observableArray(['none', 'connect', 'disconnect', 'home', 'pause', 'resume', 'toggle pause-resume', 'start', 'start latest', 'cancel', 'toggle start-cancel', 'toggle start latest-cancel']);
